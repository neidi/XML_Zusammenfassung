...
\input{Chapters/Basics/binary_files.tex}

\subsection{Text Files}
\input{Chapters/Basics/text_files.tex}

\section{Metadaten}
\input{Chapters/Basics/metadaten.tex}

\section{SGML - Der Vorgänger von XML}
\input{Chapters/Basics/sgml.tex}

\section{XML - Extensible Markup Language}
\input{Chapters/Basics/xml.tex}

\subsection{Advantages of XML}
\input{Chapters/Basics/xml_advantages.tex}


\section{Data-Centric vs Document-Centric Use of XML}
\subsection{Data-Centric Use of XML}
\input{Chapters/Basics/data_centric.tex}

\subsection{Document-Centric Use of XML}
\input{Chapters/Basics/document_centric.tex}

\subsection{Hybride Verwendung von XML}
\input{Chapters/Basics/hybrid_use.tex}

\nottoggle{zusammenfassung}{
\section{XML Anwendungen}
\input{Chapters/Basics/xml_anwendung.tex}
}
\nottoggle{zusammenfassung}{
\section{Intermezzo: JSON - Javascript Object Notation}
\input{Chapters/Basics/json.tex}
}
\nottoggle{zusammenfassung}{
\section{A non-religious Discussion of XML vs. JSON}
\input{Chapters/Basics/xml_json.tex}
}

\nottoggle{zusammenfassung}{
\section{CRDATA Sections}
\input{Chapters/Basics/crdata.tex}
}

\section{Processing Instructions}
\input{Chapters/Basics/processing_instructions.tex}

\section{Well Formed XML and Error Handling}
\input{Chapters/Basics/well_formed.tex}

\subsection{XML Prolog}
\input{Chapters/Basics/xml_prolog.tex}

\subsection{Elements and Attributes}
\input{Chapters/Basics/elements_attributes.tex}

\subsection{Root and Nested Element}
\input{Chapters/Basics/root_nested.tex}

\section{Equal vs Equivalent}
\input{Chapters/Basics/equal_equivalent.tex}

\section{Control Questions A}
\input{Chapters/Basics/qa_A.tex}

\section{Control Questions B}
\input{Chapters/Basics/qa_B.tex}
